...
<img alt="Nockerl Voice dashboard: transcription and word counts, total and longest recording time, most frequent words, and a thirty day chart." src="art/screenshots/dashboard.webp" width="860">
